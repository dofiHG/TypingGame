...
public class PausePanelActiv : MonoBehaviour
{
    ...
    private void Awake() => moverScript = GameObject.Find("Plane").GetComponent<CameraMover>();
    ...
    public void ClosePusePanel()
    {
        ...
        if (speedSave != tempSpeed)
        {
            averageSpeedPause.text = "-";
            averageSpeedDeath.text = "-";
        }
    ...
    public void OpenPausePanel()
    {
        ...
        speedSave = moverScript.environmentSpeed;
